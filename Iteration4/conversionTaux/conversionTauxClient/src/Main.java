     ...
     */
     ...
     try {
         InitialContext ctx = new InitialContext();
            ...
            System.out.println(admin.top5taux());
            System.out.println(admin.connecter("admin", "admin"));
            System.out.println(admin.consulterNbConnexion());

      /*       System.out.println(abonne1.ajouterFavori("f90", "euros", "nok"));
            System.out.println(abonne1.ajouterFavori("f91", "euros", "nok"));
            System.out.println(abonne1.ajouterFavori("f93", "nok", "euros"));
            System.out.println(abonne1.ajouterFavori("f94", "dollars", "euros"));
            System.out.println(abonne2.ajouterFavori("f92", "euros", "nok"));
            System.out.println(abonne2.ajouterFavori("f95", "dollars", "euros"));

            System.out.println(abonne1.ajouterFavori("f96", "euros", "yen")); 
            System.out.println(abonne2.ajouterFavori("f97", "euros", "yen"));*/


            

            System.out.println(abonne1.listerFavoris());
